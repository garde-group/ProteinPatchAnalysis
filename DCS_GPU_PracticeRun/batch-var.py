...
history = vae.fit(x=x_train, y=None,shuffle=True,epochs=5,batch_size=batch_size,validation_data=(x_test, None),callbacks=[time_callback])
...
vae.save('Histories/vae-xxx.h5')
vae.save('Histories/encoder-xxx.h5')
vae.save('Histories/decoder-xxx.h5')
